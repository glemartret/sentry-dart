...
- Bump Android SDK from v8.33.0 to v8.39.0 ([#6](https://github.com/glemartret/sentry-dart/pull/6))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8390)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.33.0...8.39.0)
